...
\vspace{4mm}
\begin{itemize}
\item Substituir o processo anterior realizado em planilhas
\item Centralização das informações de agendamentos
\item Automatização do fluxo de agendamento
\end{itemize}
\end{frame}
...
\begin{itemize}
\item \textit{Back-end}: Java
\item \textit{Front-end}: JavaScript
\end{itemize}
\item \textbf{Banco de Dados:} PostgreSQL
\item \textbf{Frameworks de Desenvolvimento:}
\begin{itemize}
\item \textit{Front-end}: React
\item \textit{Back-end}: Spring Boot
\end{itemize}
\end{itemize}
\end{frame}
...
% ---- Diagramas de Sequência: Usuário ----
\begin{frame}
...
\caption{Fluxo atual do processo de agendamento}
\end{figure}
\end{frame}
...
\item Especificação Complementar
\item Glossário
\item Solicitação dos Principais Envolvidos
\item Especificação de Caso de Uso
\end{itemize}
\end{frame}
...
\textbf{Tópicos apresentados:}
\begin{itemize}
\item Objetivos e motivações do projeto
\item Tecnologias utilizadas
\item Diagramas (caso de uso, DER, implantação)
\item Workflow AS-IS do processo de agendamento
\item Telas do sistema desenvolvido
