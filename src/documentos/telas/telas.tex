...
\begin{figure}[H]
    ...
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=1.5\textwidth,trim=5cm 12cm 6cm 15cm,clip]{telas/login.png}
    }
...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=1\textwidth]{telas/gerenciar-salas.png}
    {\footnotesize \textbf{Fonte:} O autor.}
\end{figure}
...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=1\textwidth]{telas/buscar-sala.png}
    {\footnotesize \textbf{Fonte:} O autor.}
\end{figure}
...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=1\textwidth]{telas/minhas-reservas.png}
    {\footnotesize \textbf{Fonte:} O autor.}
\end{figure}
...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=1\textwidth]{telas/solicitacoes.png}
    {\footnotesize \textbf{Fonte:} O autor.}
\end{figure}
...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=1\textwidth]{telas/grade-horarios.png}
    {\footnotesize \textbf{Fonte:} O autor.}
\end{figure}
...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=1\textwidth]{telas/montar-grade.png}
    {\footnotesize \textbf{Fonte:} O autor.}
\end{figure}
