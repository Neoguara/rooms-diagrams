\chapter{Recursos e ambiente de desenvolvimento}\label{sec:5}

Nesta seção se apresentam todas as tecnologias que serão utilizadas durante o desenvolvimento do projeto.
